...
/* ─── WORD ROTATE ─────────────────────────────────────────────── */
const ROTATE_WORDS = ["DEALS", "DISCOUNTS", "PERKS", "SAVINGS", "OFFERS", "FREEBIES", "VOUCHERS"];
    ...
    return (
        <span style={{
            ...
            <span style={{
                display: "inline-block",
                opacity: visible ? 1 : 0,
                transform: visible ? "translateY(0)" : "translateY(-40%)",
...
export default function DealScout() {
    ...
    return (
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes slideUp { from { opacity:0; transform:translateY(60%); } to { opacity:1; transform:translateY(0); } }
      `}</style>
            ...
            <div style={{ maxWidth: 1200, margin: "0 auto", padding: "64px 24px 0" }}>
                <div style={{ textAlign: "center", marginBottom: 44 }}>
                    ...
                    <h1 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "clamp(56px,10vw,120px)", lineHeight: 0.93, letterSpacing: "0.02em", marginBottom: 18 }}>
                        SEARCH EVERY STUDENT<br /><span style={{ color: accent }}><WordRotate /></span>
                    </h1>
